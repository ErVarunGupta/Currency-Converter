...
//Array to popuolate the select tags with these countries
const countries = [
    ...
    {code: "IDR", name: "Indojesian Rupiah"},
    {code: "ILS", name: "Israeli New Shekel"},
    {code: "INR", name: "Indian Rupee"},
    {code: "ISK", name: "Icelandic Krona"},
    {code: "JPY", name: "japanese Yen"},
    {code: "KRW", name: "South Koran Won"},
...
//Fetching exchange rate when user inputs the currency
